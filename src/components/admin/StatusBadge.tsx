...
const toneMap: Record<string, string> = {
  ...
  dibalas: "bg-blue-50 text-blue-700 ring-blue-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.68)]",
  ...
  belum_dibalas: "bg-amber-50 text-amber-700 ring-amber-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.65)]",
  ...
  bounced: "bg-rose-50 text-rose-700 ring-rose-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)]",
  complaint: "bg-rose-50 text-rose-700 ring-rose-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)]",
  ...
  selesai: "bg-emerald-50 text-emerald-700 ring-emerald-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)]",
  arsip: "bg-slate-100 text-slate-700 ring-slate-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.72)]",
};
